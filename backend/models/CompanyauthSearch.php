...
/**
 * CompanyauthSearch represents the model behind the search form about `common\models\Companyauth`.
 */
class CompanyauthSearch extends Companyauth
{
    /**
     * @inheritdoc
     */
